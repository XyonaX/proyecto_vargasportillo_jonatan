<main class="min-vh-100 d-flex justify-content-center align-items-center flex-column animate__animated animate__fadeIn">
    <div class="container-fluid">
        <div class="table-wrapper">
            ...
            <div class="table-responsive">
                ...
                <div class="clearfix">
                    <div class="hint-text">Showing <b><?= is_array($productos) ? count($productos) : 0 ?></b> out of <b><?= $pager->getTotal() ?></b> entries</div>
...
<div class="modal fade animate__animated animate__fadeInDown" id="newProduct" tabindex="-1" aria-labelledby="newProductLabel" aria-hidden="true">
...
<div class="modal fade animate__animated animate__fadeInDown" id="editProductModal" tabindex="-1" aria-labelledby="editProductModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
